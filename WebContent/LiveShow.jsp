          ...
          <div class="stream-chat theater-mode-chat-container">
              ...
              <div class="placeholder-for-chat no-chat">
                <div class="box-container">
					...
					<div id="MessagesArea"
						style="height: 305px; border-bottom: 1px solid #DDDDDD;overflow-x: hidden; overflow-y: scroll">
					</div>
					<script type="text/javascript">var user = '${user.memberAccount}';</script>
								...
								<div   id="sendMessageArea">
									...
									<div class="form-group" style="float:right; margin:10px 10px 10px 0px">
										<button class="btn btn-primary btn-sm " type="submit" value="Send" onclick="sendMessage()" >聊天</button>
									</div>
